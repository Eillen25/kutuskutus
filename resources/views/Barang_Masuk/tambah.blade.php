...
<div class="card-body" style="margin-top: 40px">
    ...
    <div class="ini">
        <div class="col">
            ...
            <input type="text" class="form-control" id="fullName" value="B01234" >
        </div>
        <div class="col mb-4">  
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" id="fullName" value="Minyak Tanamu Tanami" >
        </div>
    </div>
    <div class="row align-items-end">
        ...
        <div class="col">
                ...
                <input type="text" class="form-control" value="325000" >
        </div>
        <div class="col">    
