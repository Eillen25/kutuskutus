        ...
        <div class="row gutters">
            ...
            <div class="ini">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="fullName" value="{{$exit->nota_id}}" readonly>
                </div>

                <div class="col">
                    <label for="fullName" class='font-weight-bold'>Nama Admin</label>
                    <input type="text" class="form-control" id="fullName" value="{{$exit->admin->nama_admin}}" readonly>
                </div>
                <div class="col ">
            ...
            <div class="row">
                <div class="col mb-4 ml-4">
                    ...
                    <input type="date" class="form-control" id="from-datepicker" value="{{$exit->tanggal}}" readonly>
                </div>
            </div>
            <div class="row align-items-end">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control" value="{{$exit->sudah_dibayar}}">
                </div>
                <div class="col">
